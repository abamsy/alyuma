                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <a href="ballocations/{{$plant->id}}" class="text-yellow-400 hover:text-yellow-600">View</a>
                            <a href="#" class="text-indigo-600 hover:text-indigo-900" wire:click="editModal({{ $plant->id }})">Edit</a>
                            <a href="#" class="text-red-600 hover:text-red-900" wire:click="deleteConfirm({{ $plant->id }})">Delete</a>
                        </td>
                        </tr>
                        @empty
                        <tr>
                    ...
                    <div class="px-3 py-3">{{$plants->links()}}</div>
                </div>
                </div>
            </div>
            </div>
                ...
                <x-slot name="content">
                    ...
                    <div class="mt-4">
                        ...
                        <select id="user_id" name="user_id" class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block mt-1 w-full" wire:model.debounce.800ms="user_id">
                            <option value="">--Please choose receiver--</option>
