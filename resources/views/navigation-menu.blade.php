<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    @if (Auth::user()->isReceiver())
                        <a href="{{ route('ballocations', [Auth::user()->plant->id]) }}">
                            <x-jet-application-mark class="block h-9 w-auto" />
                        </a>
                    @elseif (Auth::user()->isDispatcher())
                        <a href="{{ route('lallocations', [Auth::user()->point->id]) }}">
                            <x-jet-application-mark class="block h-9 w-auto" />
                        </a>
                    @else
                    <a href="{{ route('users') }}">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <x-jet-nav-link href="{{ route('plants') }}" :active="request()->routeIs('plants')">
                        {{ __('Blending Plants') }}
                    </x-jet-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @can ('manage-users')
            ...
            <x-jet-responsive-nav-link href="{{ route('plants') }}" :active="request()->routeIs('plants')">
                {{ __('Blending Plants') }}
            </x-jet-responsive-nav-link>
            <x-jet-responsive-nav-link href="{{ route('points') }}" :active="request()->routeIs('points')">
                {{ __('Loading Points') }}
            </x-jet-responsive-nav-link>
